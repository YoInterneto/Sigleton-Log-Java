 ...
 * @author YoInterneto
 */
public final class LoggerDB {
    private static final LoggerDB instanceLog = new LoggerDB();
    ...
    public static LoggerDB getInstance(String name){
    ...
    public void createLogFile(){
        ...
        LoggerDB.logFile = new File(path);
        try{
    ...
    public void info(String message){
        try{
            FileWriter output = new FileWriter(LoggerDB.logFile, true);
